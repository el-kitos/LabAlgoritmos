...
mcdonals = Restaurante("Mcdonals", "Chatarra")
burgerking = Restaurante("Burguer King", "Chatarra")
kentucky = Restaurante("Kentucky", "Pizzas")

parrilla.describir_restaurante()
pizzeria.describir_restaurante()
mcdonals.describir_restaurante()
burgerking.describir_restaurante()
kentucky.describir_restaurante()